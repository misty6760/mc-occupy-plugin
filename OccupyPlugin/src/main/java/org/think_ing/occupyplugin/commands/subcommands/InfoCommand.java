...
public class InfoCommand implements SubCommand {
    ...
    public boolean execute(@NotNull CommandSender sender, @NotNull String[] args) {
        ...
        sender.sendMessage(ChatColor.WHITE + "  점령지를 점령하여 " + ChatColor.YELLOW + "4점" + ChatColor.WHITE + "을 먼저 획득하는 팀이 승리!");
        ...
        sender.sendMessage(ChatColor.WHITE + "  • 기본 3개 점령 시: " + ChatColor.LIGHT_PURPLE + "+1점 보너스");
        sender.sendMessage("");
        
        // 승리 조건
        sender.sendMessage(ChatColor.GREEN + "■ 승리 조건");
        sender.sendMessage(ChatColor.WHITE + "  방법 1: " + ChatColor.AQUA + "기본 3개" + ChatColor.WHITE + " + " + ChatColor.LIGHT_PURPLE + "보너스 1점" + ChatColor.WHITE + " = " + ChatColor.GOLD + "4점");
        sender.sendMessage(ChatColor.WHITE + "  방법 2: " + ChatColor.GOLD + "중앙 2점" + ChatColor.WHITE + " + " + ChatColor.AQUA + "기본 2개" + ChatColor.WHITE + " = " + ChatColor.GOLD + "4점");
        sender.sendMessage("");
        ...
        sender.sendMessage(ChatColor.RED + "  이그니스(불)" + ChatColor.WHITE + ": 화염 저항 + 파티클");
        sender.sendMessage(ChatColor.BLUE + "  아틀란스(물)" + ChatColor.WHITE + ": 수중 호흡, 돌고래의 가호 + 파티클");
        sender.sendMessage(ChatColor.AQUA + "  크라이오시스(얼음)" + ChatColor.WHITE + ": 구속 면역 (다른 팀은 구속) + 파티클");
        sender.sendMessage(ChatColor.WHITE + "  사이클론즈(바람)" + ChatColor.WHITE + ": 신속 + 파티클");
        sender.sendMessage("");
        ...
        sender.sendMessage(ChatColor.GRAY + "  • " + ChatColor.AQUA + "청금석 64개" + ChatColor.GRAY + " → " + ChatColor.GREEN + "경험치 병 64개");
        sender.sendMessage(ChatColor.GRAY + "  • " + ChatColor.WHITE + "철괴 32개" + ChatColor.GRAY + " → " + ChatColor.GOLD + "빵 64개");
        sender.sendMessage("");
